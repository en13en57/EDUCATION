...
public class Exam04 {
	public static void main(String[] args) {
		...
		System.out.println("업앤다운 UP&DOWN 숫자맞추기 게임");
		System.out.println("컴퓨터가 생각한 1~100사이의 숫자를 맞춰보세요");
		...
		do {
			...
			n = sc.nextInt();
			++count;
			if (num<n) System.out.println("DOWN");
			if (num>n) System.out.println("UP");
		}while(num !=n);
		System.out.println(count + "회만에 맞췄어요.");
	}
}
