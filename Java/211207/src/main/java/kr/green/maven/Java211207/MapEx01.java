...
// Map : (키,값) 형태의 자료구조 유일한것.(학번 학생정보, 주민번호 주민정보)
public class MapEx01 {
	public static void main(String[] args) {
		Map<Integer, String> map1 = new Hashtable<>(); // 멀티스레드에 안전하게 설계되었다. (옛것)
		// 넣기
		map1.put(1,"한사람");
		map1.put(2,"두사람");
		map1.put(3,"세사람");
		...
		Map<Integer, String> map2 = new HashMap<>(); // 싱글 스레드에만 안전하게 설계되었다. (최신)
		// 넣기
		map2.put(1,"한사람");
		map2.put(2,"두사람");
		map2.put(3,"세사람");
