...
public class AwatSwingEx01 {
	public static void main(String[] args) { // 디자인 끝나면 이벤트 등록
		// AWT
		...
		// frame2.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // 윈도우 종료 지정 -- 위의 것 처럼 해도 된다.
		frame2.addWindowListener(new WindowAdapter() {

			@Override
			public void windowClosing(WindowEvent e) {
				frame2.dispose(); // 자원을 반납해라! - 현재 윈도우만 종료
