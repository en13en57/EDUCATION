...
public class ImageEx05 extends JPanel{
	private static final long serialVersionUID = 2524943894658825628L;
	
	Image[] images = new Image[8]; // 이미지를 읽어서 저장할 변수
	int width, height; // 이미지 크기를 저장할 변수
	private void ImageEx01() {
		try {
		...
		System.out.println("이미지크기(" + width + ", " + height + ")");
		// 저장할 폴더를 만들자
