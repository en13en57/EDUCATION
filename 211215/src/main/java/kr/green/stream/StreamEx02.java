...
public class StreamEx02 {
	public static void main(String[] args) {
		...
		// intStream.forEach(n-> System.out.println(n + " ")); // 최종 연산 : 출력
		// System.out.println();
		...
		Stream<Integer> evenStream = Stream.iterate(100, n->n+2); // 100부터 짝수 10개의 스트림 생성 
		...
		for(int i=0; i<10; i++) {
			...
			lottoStream.forEach(n->System.out.print(n+" ")); 
			System.out.println();
		}
		System.out.println();
		// 자바에서 제일 짧은 로또번호 생성기
